...
const {darkMode} = useDarkMode();
  return (
    <div className={`${darkMode === "dark" ? "bg-black" : "bg-transparent"} pb-20`}>
        <section id="testimonials" className='lg:w-[95%] w-full h-fit m-auto bg-cover bg-center rounded-xl flex justify-center 
      flex-col items-start lg:px-20 px-6 py-20 gap-20'>
        <div className='flex flex-col justify-center items-start gap-4'>
          <h1 data-aos="zoom-in" className='text-red-500 dark:text-white'>OUR CLIENTS</h1>
          <h1 data-aos="zoom-in" className='text-red-500 dark:text-white text-[40px]
